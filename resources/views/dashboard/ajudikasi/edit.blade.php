...
<div class="col-lg-8">
  <form action="/dashboard/ajudikasi/{{ $putusan->id }}" method="POST" class="mb-5" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('nomor_putusan')is-invalid @enderror" id="nomor_putusan"
        name="nomor_putusan" autofocus required value="{{ old('nomor_putusan', $putusan->nomor_putusan) }}">
      @error('nomor_putusan')
    ...
    <div class="mb-3">
      ...
      <input type="date" class="form-control @error('tanggal')is-invalid @enderror" id="tanggal" name="tanggal" required
        value="{{ old('tanggal', $putusan->tanggal) }}">
      @error('tanggal')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('registrasi_sengketa')is-invalid @enderror" id="registrasi_sengketa"
        name="registrasi_sengketa" required value="{{ old('registrasi_sengketa', $putusan->registrasi_sengketa) }}">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('pemohon')is-invalid @enderror" id="pemohon" name="pemohon" required
        value="{{ old('pemohon', $putusan->pemohon) }}">
      @error('pemohon')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('termohon')is-invalid @enderror" id="termohon" name="termohon"
        required value="{{ old('termohon', $putusan->termohon) }}">
      @error('termohon')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
