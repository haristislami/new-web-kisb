...
<div class="table-responsive col-lg-12">
  <a href="/dashboard/berita/create" class="btn btn-primary mb-3">Create New</a>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="/dashboard/berita/{{ $berita->slug }}/edit" class="badge bg-warning"><span
