...
@section('container')
    <h1>PUTUSAN MEDIASI SENGKETA INFORMASI</h1>
    <div class="row">
        <div class="col-md-4">
            ...
            <nav class="nav">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-decoration-none text-danger"
                            href="/ajudikasi">Ajudikasi</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Mediasi</li>
